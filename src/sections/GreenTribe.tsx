            ...
            <div className="glass p-6 lg:p-8 backdrop-blur-xl">
              ...
              <form className="space-y-4">
                <input
                  ...
                  className="w-full px-4 py-3 bg-transparent border border-brand-border text-brand-text placeholder:text-brand-light-gray text-sm focus:outline-none focus:border-brand-text transition-colors"
                />
                <button
                  type="submit"
                  className="w-full px-4 py-3 bg-brand-text text-brand-linen font-roboto text-sm uppercase tracking-wider hover:bg-brand-dark-gray transition-colors cursor-hover"
                >
